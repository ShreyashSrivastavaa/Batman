...
export const SocialLinks: React.FC = () => {
  ...
  return (
    <div className="flex gap-6 items-center">
      ...
      <a href="https://linkedin.com/in/shreyashsrivastava" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><Linkedin className={iconClass} strokeWidth={1.5} /></a>
